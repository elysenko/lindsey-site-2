...
exports.SERVICES = [
    {
        ...
        summary: 'We help you find the single, defensible idea that makes your brand the obvious choice in its category, grounded in evidence rather than adjectives.',
        outcomes: [
    ...
    },
    {
        ...
        summary: 'We translate strategy into a narrative and message architecture your teams can apply consistently across every channel and audience.',
        outcomes: [
    ...
    },
    {
        ...
        summary: 'We express your strategy as a disciplined visual and verbal identity — distinctive, coherent, and built to last rather than to trend.',
        outcomes: [
    ...
    },
    {
        ...
        summary: 'We design the competitive and audience research that grounds every engagement, turning signal into the strategic decisions brand depends on.',
        outcomes: [
...
function findService(slug) {
    return exports.SERVICES.find((s) => s.slug === slug);
}
